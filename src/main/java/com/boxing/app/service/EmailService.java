...
public class EmailService {
    ...
    public void sendConfirmationEmail(String toEmail, String name, String program) {
        ...
        <head>
          <meta charset="UTF-8">
          <title>Boxing Registration Confirmed</title>
        </head>
        ...
        sendEmail(toEmail, "Boxing Registration Confirmed", htmlMessage);
    }
    public void sendAdminNotification(String adminEmail, JoinBatchRequest request) {
        ...
        <head>
          <meta charset="UTF-8">
          <title>New Boxing Registration</title>
        </head>
          ...
          <table width="100%%" cellpadding="0" cellspacing="0"
            ...
            <tr>
              <td style="background-color: #2c3e50; color: #ffffff;
                         padding: 20px; text-align: center;">
                <h2 style="margin: 0;">🏋️ New Boxing Registration Alert</h2>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding: 20px; color: #333333;">
                ...
                <p>
                  A new user has registered for your boxing program.
                ...
                <p style="font-size: 12px; color: #888;">
                  This is an automated notification from the boxing Registration System.
                </p>
            ...
            <tr>
              <td style="background-color: #2c3e50;
                         ...
                         text-align: center;
                         padding: 10px;">
                <p style="margin: 0;">© 2026 Boxing Team</p>
              </td>
            </tr>
        ...
        sendEmail(adminEmail, "New Boxing Registration - " + request.getProgram(), htmlContent);
    }
